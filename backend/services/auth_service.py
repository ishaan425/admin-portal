...
def require_org_admin(
    ...
    local_clerk_user_id: str | None = None,
    ...
    if settings.auth_allow_local_headers:
        return require_local_org_admin(
            conn,
            clerk_user_id=local_clerk_user_id or "",
            organization_slug=organization_slug,
        )
...
def require_local_org_admin(
    ...
    if not clerk_user_id:
        raise AuthError("X-Local-Clerk-User-Id header is required for local auth.")
